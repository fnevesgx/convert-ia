...
- [x] Descrição de controles (fonte × UI): `controles[]` no inventário, `rotulo_ui`/`nome_fonte` no catálogo, tabela na seção 2 da spec — design em [`docs/superpowers/specs/2026-08-03-descricao-controles-design.md`](./docs/superpowers/specs/2026-08-03-descricao-controles-design.md).
