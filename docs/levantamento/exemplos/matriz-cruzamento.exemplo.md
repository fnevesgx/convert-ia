...
Cada linha `confirmado` alimenta o [`spec-generator`](../../../skills/spec-generator/SKILL.md): os ids de tela, objeto e regra entram no frontmatter (`origem.telas` / `origem.programas` / `origem.regras`) e os `casos_replay` semeiam a seção 9. Ver o resultado em [`CONV-0001`](../../specs/exemplos/CONV-0001.md).
